...
type ManualCompareUIProps = {
  hasConnectedApiKey: boolean;
};

export function ManualCompareUI({ hasConnectedApiKey }: ManualCompareUIProps) {
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground">
          Paste outputs from any assistant and synthesize them with your
          connected API key. Upload files or images as additional sources.
        </p>
      </div>
      ...
      {!hasConnectedApiKey && (
        <div className="rounded-lg border border-amber-500/40 bg-amber-500/5 p-4 text-sm text-amber-900 dark:text-amber-200">
          ...
          <Link
            ...
            className="font-medium underline underline-offset-4 hover:text-amber-700 dark:hover:text-amber-100"
          >
            Settings → API Keys
          </Link>{" "}
          to use Manual Compare.
        </div>
      )}
